...
const SmokeBackground = ({ backgroundColor }: SmokeBackgroundProps) => (
	<View style={StyleSheet.absoluteFill} pointerEvents="none">
		<Image
			source={smokeGif}
			style={[StyleSheet.absoluteFillObject, { opacity: 0.68 }]}
			contentFit="cover"
			transition={240}
		/>
		<View
		...
		>
			<LinearGradient style={{ flex: 1 }} colors={gradientColors}>
				...
				<View style={themedStyles.overlayContainer}>
					...
					<View style={themedStyles.lightOverlay} pointerEvents="none">
						<View style={themedStyles.lightDimmer} />
						<Image source={smokeGif2} style={themedStyles.lightImage} contentFit="cover" />
					</View>
				</View>
			</LinearGradient>
		</Animated.View>
...
const styles = (
	...
	StyleSheet.create({
		...
		lightDimmer: {
			...StyleSheet.absoluteFillObject,
			backgroundColor: withOpacity(backgroundColor, 0.16),
			zIndex: 1,
		},
		lightImage: {
			width: '100%',
