			...
			<LinearGradient style={{ flex: 1 }} colors={gradientColors}>
				...
				<View style={themedStyles.smokeContainer} pointerEvents="none">
					<SmokeLayer
						...
						blur={24}
						opacity={0.58}
						animatedStyle={[themedStyles.smoke, themedStyles.smokeLarge, smokePrimaryStyle]}
					/>
					...
					<SmokeLayer
						...
						blur={20}
						opacity={0.44}
						animatedStyle={[themedStyles.smoke, themedStyles.smokeMedium, smokeSecondaryStyle]}
					/>
					...
					<SmokeLayer
						...
						blur={18}
						opacity={0.38}
						animatedStyle={[themedStyles.smoke, themedStyles.smokeSmall, smokeTertiaryStyle]}
					/>
				</View>
